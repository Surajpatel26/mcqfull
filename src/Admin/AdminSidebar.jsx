...
import { faFileCsv, faQuestionCircle, faUsers, faSignOutAlt, faListAlt } from '@fortawesome/free-solid-svg-icons'; // Importing relevant icons
    ...
    return (
        <div className="admin-sidebar">
            <ul className="sidebar-menu">
                ...
                <li>
                    <Link to="/admin/subtopics" className="sidebar-link">
                        <FontAwesomeIcon icon={faListAlt} className="sidebar-icon" /> Manage Subtopics
                    </Link>
                </li>
                <li>
                    <button onClick={handleLogout} className="sidebar-link logout">
                        <FontAwesomeIcon icon={faSignOutAlt} className="sidebar-icon" /> Sign Out
                    </button>
                </li>
            </ul>
        </div>
